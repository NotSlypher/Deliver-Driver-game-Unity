...
public class Delivery : MonoBehaviour
{
    ...
    void LateUpdate()
    {
        ...
        if (hasPackage)
        {
            ...
            if (Vector3.Distance(post1, spriteRenderer2.transform.position) >
                Vector3.Distance(post2, spriteRenderer2.transform.position))
                dir = post1 - spriteRenderer2.transform.position;
            else
                dir = post2 - spriteRenderer2.transform.position;
        }
        else
        {
